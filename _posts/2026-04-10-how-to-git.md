...
此处讲的是团队协作时的 Git 使用方法，因此这里的前提假设是我们的代码仓库已经上传到 Github、Gitlab 等托管平台。在团队协作时自己的代码一般会上传到远程仓库，便于成员拉取或者 Fork 之类的。

首先我们要找到以下两条信息：

1. 仓库的 URL. 
2. 分支名称（feature-branch），也就是自己创建的分支的名称，没有的话就自己编一个。

知道了以上信息，我们就可以开始使用 Git 了，接下来就是填空题。
